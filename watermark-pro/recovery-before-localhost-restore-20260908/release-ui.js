...
window.WPLogoutRoute=()=>{routeApplied=false;history.replaceState({},'',authURL.href);};
...
document.addEventListener('click',e=>{
 ...
 const path=authURL.href+(routeMap[page]?'#/'+routeMap[page]:'');if(location.href!==path)history.pushState({page},'',path);
});
