...
for(const name of ['app-icon-192.png','app-icon-512.png']){const source=path.join(__dirname,'legacy-ui-2026-09-03',name);fs.copyFileSync(source,path.join(out,name));fs.copyFileSync(source,path.join(__dirname,name));}
