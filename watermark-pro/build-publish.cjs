...
const files=['request-layout.css','index.html','control.html','avatar-render.js','release-ui.js','control-release.js','wmark-shared.js','pwa.js','sw.js','manifest.webmanifest','favicon-rounded.png','logo.jpg','bg.jpg','qr.jpg','threads.svg','og-image.jpg'];
